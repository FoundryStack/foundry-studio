defmodule FoundryWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :foundry_web
  ...
  @session_options [
    store: :cookie,
    key: "_foundry_web_key",
    signing_salt: "0+BE4Ebd",
    same_site: "Lax"
  ]
